...
//            //REF.playerCamera = (Camera)EditorGUILayout.ObjectField(GetGUIContent("playerCamera", "The camera used by the character controller"),
//            // REF.playerCamera, typeof(Camera), true);

//           // REF.camRoot = (Transform)EditorGUILayout.ObjectField(GetGUIContent("playerCamera", "The camera used by the character controller"),REF.camRoot, typeof(Transform), true);
...
//                    InternalEditorUtility.LayerMaskToConcatenatedLayersMask(REF.groundLayers),
//                    InternalEditorUtility.layers);
//                REF.groundLayers = InternalEditorUtility.ConcatenatedLayersMaskToLayerMask(tempMask);

//                LayerMask tempignoreMask = EditorGUILayout.MaskField("Ignore Layers",
//                  InternalEditorUtility.LayerMaskToConcatenatedLayersMask(REF.ignoreLayers),
//                  InternalEditorUtility.layers);
//                REF.ignoreLayers = InternalEditorUtility.ConcatenatedLayersMaskToLayerMask(tempignoreMask);
