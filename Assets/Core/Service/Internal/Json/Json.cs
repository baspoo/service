 ...
 class JsonArray : List<object>
    {
        ...
        {
            return Json.SerializeObject(this) ?? string.Empty;
        }
    }
 ...
 IDictionary<string, object>
    {
        ...
        public override string ToString()
        {
            return Json.SerializeObject(_members);
        }
 ...
 static class Json
    {
        ...
        static bool SerializeValue(IJsonSerializerStrategy jsonSerializerStrategy, object value, StringBuilder builder)
        {
            ...
            else
            {
                ...
                var isStringKeyDictionary = type.GetType().IsGenericType && type.GetGenericTypeDefinition() == typeof(Dictionary<,>) && genArgs[0] == typeof(string);
 ...
 class PocoJsonSerializerStrategy : IJsonSerializerStrategy
    {
        ...
        public virtual object DeserializeObject(object value, Type type)
        {
            ...
            if (nullableType != null && Json.NumberTypes.IndexOf(nullableType) != -1)
                type = nullableType; // Just use the regular type for the conversion
            bool isNumberType = Json.NumberTypes.IndexOf(type) != -1;
            bool isEnumType = type.GetType().IsEnum;
