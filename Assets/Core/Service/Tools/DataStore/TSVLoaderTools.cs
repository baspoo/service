...
#if UNITY_EDITOR
public class TSVLoaderToolsGui : EditorWindow
{
	[MenuItem(EditorGUIService.ProjectPath.header + "/Data/Update Tsv")]
	public static void ShowWindow()
	{
		EditorWindow.GetWindow(typeof(TSVLoaderToolsGui));
	}
	void Update()
	{
		Repaint();
	...
	void OnGUI()
	{
		...
		if (GUILayout.Button("GoToResource"))
		{
			Selection.activeObject = TSVLoaderTools.loaderData.gameObject;
		}
		if (GUILayout.Button("Clear CacheTsv"))
		{
			Selection.activeObject = TSVLoaderTools.loader.gameObject;
		}
