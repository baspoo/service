...
namespace EditorService
{
    ...
    public class EditorCoroutine
    {
        ...
        bool m_IsDone;
        System.Action m_onDone;

        internal EditorCoroutine(IEnumerator routine , System.Action onDone = null)
        {
            m_Owner = null;
            m_Routine = routine;
            m_onDone = onDone;
        ...
        internal EditorCoroutine(IEnumerator routine, object owner, System.Action onDone = null)
        {
